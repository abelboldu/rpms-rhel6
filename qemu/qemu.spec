...
# Added all Abiquo images support (QCOW,QCOW2,VDI,VMDK,RAW,VHD)
./configure --target-list=x86_64-softmmu \
            ...
            --disable-xen \
            --block-drv-whitelist=qcow2,raw,file,host_device,host_cdrom,qed,qcow,vdi,vmdk,vpc \
            --enable-kvm \
            --enable-vnc-tls \
            --enable-vnc-sasl \
...
%changelog
* Fri May 25 2012 Abel Boldú <abel.boldu@abiquo.com> - 2:0.13.0-3
- Added KVM support, block drivers

* Wed May 23 2012 Abel Boldú <abel.boldu@abiquo.com> - 2:0.13.0-2
- Abiquo EL6 Additions
